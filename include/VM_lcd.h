...
void Display_GB2312(unsigned short int x, unsigned short int y, unsigned char zk_num, unsigned short int fc, unsigned short int bc);
void Display_GB2312_String(unsigned short int x, unsigned short int y, unsigned char zk_num, unsigned char text[], unsigned short int fc, unsigned short int bc);
...
#define LCD_MOSI_Clr() IO_operation_virtual()
#define LCD_MOSI_Set() IO_operation_virtual()
#define LCD_SCLK_Clr() IO_operation_virtual()
#define LCD_SCLK_Set() IO_operation_virtual()
#define LCD_CS_Clr()   IO_operation_virtual()
#define LCD_CS_Set()   IO_operation_virtual()
#define LCD_DC_Clr()   IO_operation_virtual()
#define LCD_DC_Set()   IO_operation_virtual()
#define LCD_BLK_Clr()  IO_operation_virtual()
#define LCD_BLK_Set()  IO_operation_virtual()
#define ZK_MISO        IO_operation_virtual()

#define ZK_CS_Set()    IO_operation_virtual()
#define ZK_CS_Clr()    IO_operation_virtual()

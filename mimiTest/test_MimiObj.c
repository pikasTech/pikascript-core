...
int TEST_MimiObj(int isShow)
{
    ...
    }
    {
        ...
        obj_runWithCheck(obj, "hello(name = 'world', isShow = isShow)");
        obj_deinit(obj);
    }
    {
        MimiObj *obj = New_MimiObj(NULL);
        ...
        obj_setInt(obj, "isShow", isShow);
        obj_runWithCheck(obj, "hello2(name2 = 'tom', \
                              name1 = 'john', \
                              name3 = 'cat', \
                              isShow = isShow) ");
        obj_deinit(obj);
    }
    {
        ...
        obj_setInt(obj, "isShow", isShow);
        obj_runWithCheck(obj, "hello.hello2(name2 = 'tom', \
                                    name1 = 'john', \
                                    name3 = 'cat', \
                                    isShow = isShow) ");
        obj_deinit(obj);
    }
    {
        ...
        obj_defineMethod(obj, "hello.hello2(name1:string, name2:string, name3:string, isShow:int)",
                         hello2);
        obj_runWithCheck(obj, "hello.hello2(name2 = 'tom', name1 = name1, name3 = 'cat', isShow = isShow) ");
        obj_deinit(obj);
    }
    {
        MimiObj *obj = New_MimiObj(NULL);
        ...
        obj_runWithCheck(obj, "res = testFloat(val1 = 3.22,val2 = val2,isShow = isShow)");
    ...
    }
    {
        ...
        obj_runWithCheck(obj, "res = add(val1 = 1, val2 = 2)");
    ...
    }
    {
        MimiObj *obj = New_MimiObj(NULL);
        obj_defineMethod(obj, "add(val1:int, val2:int):int", add);
        obj_runWithCheck(obj, "res = add(1, 2)");
        int res = obj_getInt(obj, "res");
        if (isShow)
        {
            printf("the res is %d.\r\n", res);
    ...
    }
    {
        ...
        obj_runWithCheck(sys, "set('b.a', 1)");
    ...
    }
    {
        ...
        obj_setObj(sys, "b", New_MimiObj);
        obj_runWithCheck(sys, "set('b.a', 1)");
        obj_runWithCheck(sys, "del('b.a')");
        obj_runWithCheck(sys, "set('b.a',1.2)");
